...
(function(Raphael) {
	  ...
	  var SketchPad = function(paper, options) {
		    ...
		    // The default pen.
		    var _pen = new Pen(_paper, _container);
	   ...
	   */
	  var Pen = function(paper, container) {
		    var self = this;
        ...
        _viewWidth = paper._viewBox[2];
        _viewHeight = paper._viewBox[3];
        ...
        function points_to_svg() {
            if (_points != null && _points.length > 1) {
                var p = point_to_canvas_point(_points[0]);
                var path = "M" + p[0] + "," + p[1];
                for (var i = 1, n = _points.length; i < n; i++) {
                    p = point_to_canvas_point(_points[i]);
                    path += "L" + p[0] + "," + p[1]; 
                } 
                return path;
            } else {
        ...
        function point_to_canvas_point(p) {
            var px = (p[0] / _canvasWidth) * _viewWidth;
            var py = (p[1] / _canvasHeight) * _viewHeight;
            return [px, py];
        };
    };
